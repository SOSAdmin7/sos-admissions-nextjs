...
export const services: Service[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'School selection based on specialization and competitiveness',
      'Faculty fit strategy for research-oriented programs',
      'Interview preparation and reapplication guidance',
    ],
  },
  {
    ...
    features: [
      ...
      'Interview preparation for selective graduate programs',
      'Guidance for career changers and reapplicants',
    ],
  },
  {
    ...
    features: [
      'Application planning and candidacy assessment',
      'School list strategy for MD and DO programs',
  ...
  },
  {
    ...
    features: [
      ...
      'School selection based on background and competitiveness',
      'Patient care experience and shadowing positioning',
      'Supplemental essay support for individual PA programs',
      'Interview coaching with program-specific preparation',
  ...
  },
  {
    ...
    features: [
      ...
      'School selection and program-fit guidance',
      'Interview preparation for CRNA admissions interviews',
  ...
  },
  {
    ...
    features: [
      'Statement of purpose development for NP programs',
      'Specialty and school selection guidance',
      'Resume support for bedside and advanced nursing experience',
      'Interview coaching for MSN and DNP pathways',
  ...
  },
  {
    ...
    features: [
      ...
      'School list planning for DVM programs',
      'Animal, veterinary, and research experience positioning',
      'Interview preparation for veterinary admissions',
  ...
  },
  {
    ...
    features: [
      ...
      'Interview preparation for BS-MD and honors-style interviews',
