...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDescription: 'Our doctoral admissions consultants help you apply to PhD, PsyD, EdD, and other research-focused programs. We assist with statements of purpose, research proposals, faculty identification, school selection, interview preparation, and letters of recommendation. Doctorate packages start at $4,775 for the first school plus $575 for each additional school.',
    icon: 'Microscope',
    ...
    pricing: {
      tiers: [
        ...
        },
        {
          ...
          description: 'First-school package pricing for PhD-focused applicants, plus $575 for each additional school.',
        ...
        {
          name: 'Complete Graduate School Application Package for Six Schools',
          price: 'Masters: $6,575 / Doctorate: $7,075',
          description: 'Six-school package pricing for graduate and doctorate applicants, plus $575 for each additional school.',
  ...
  },
  {
    ...
    pricing: {
      tiers: [
        ...
        {
          name: 'Complete Nursing School Application Package',
          price: 'Masters: $4,275 / Doctorate: $4,775',
          description: 'First-school package pricing for nursing applicants, plus $575 for each additional school. Unlimited hours.',
        ...
        {
          name: 'Complete Nursing School Application Package for Six Schools',
          price: 'Masters: $6,575 / Doctorate: $7,075',
          description: 'Six-school package pricing for nursing applicants, plus $575 for each additional school. Unlimited hours.',
          features: ['Everything in the complete nursing school application package', '6 schools included', 'Additional schools at $575 each'],
        },
      ],
      alaCarte: [
        { service: 'Application Planning and Evaluation', price: '$465' },
  ...
  },
  {
    ...
    pricing: {
      tiers: [
        ...
        {
          name: 'Complete PA School Application Package for Five Schools',
          price: '$7,500',
          description: 'Five-school package pricing for PA school applicants, plus $775 for each additional school. Unlimited hours.',
        ...
        {
          name: 'Complete PA School Application Package for Ten Schools',
          price: '$10,600',
          description: 'Ten-school package pricing for PA school applicants, plus $775 for each additional school. Unlimited hours.',
  ...
  },
  {
    ...
    pricing: {
      ...
      alaCarte: [
        ...
        { service: 'Traditional Interview Coaching + Mock Interview', price: '$1,275' },
        { service: 'MMI Interview Coaching + Mock Interview', price: '$1,675' },
        { service: 'Dedicated PA School MMI Interview Coaching + Mock Interview', price: '$1,475' },
        { service: 'Academic Resume/CV Creation', price: '$975' },
        { service: 'Letter of Recommendation', price: '$885' },
        { service: 'CASPA Activity Descriptions', price: '$1,175' },
        RUSH_FEE_ITEM,
    ...
    pricing: {
      tiers: [
        ...
        },
        {
          ...
          price: '$7,675',
          description: 'First-school package pricing for general nursing applicants, plus $975 for each additional school. Unlimited hours.',
        ...
        {
          name: 'Complete Nursing Application Package for Five Schools',
          price: '$10,700',
          description: 'Five-school package pricing for general nursing applicants, plus $975 for each additional school. Unlimited hours.',
          features: ['Everything in the complete nursing application package', '5 schools included', 'Additional schools at $975 each'],
        },
        {
          name: 'Complete Nursing Application Package for Ten Schools',
          price: '$14,600',
          description: 'Ten-school package pricing for general nursing applicants, plus $775 for each additional school. Unlimited hours.',
          features: ['Everything in the complete nursing application package', '10 schools included', 'Additional schools at $775 each'],
        },
      ],
      alaCarte: [
        { service: 'Application Planning and Evaluation', price: '$465' },
        { service: 'School Selection Service', price: '$1,775' },
        { service: 'Personal Statement', price: '$1,485' },
        { service: 'School-Specific Secondary Essays / Supplemental Essays', price: 'Pricing Based on Length – Call for Specifics' },
